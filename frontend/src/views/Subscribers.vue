  ...
  <section class="subscribers">
    ...
    >
        ...
        <div class="actions">
          ...
          <template v-if="bulk.checked.length > 0">
            ...
            <a
              class="a"
              href="#"
              @click.prevent="deleteSubscribers"
            ...
            <a
              class="a"
              href="#"
              @click.prevent="blocklistSubscribers"
      ...
      <b-table-column v-slot="props" cell-class="actions" align="right">
        <div>
          <a
            :href="`/api/subscribers/${props.row.id}/export`"
...
export default Vue.extend({
  ...
  methods: {
    ...
    exportSubscribers() {
      const num =
        !this.bulk.all && this.bulk.checked.length > 0
          ? this.bulk.checked.length
