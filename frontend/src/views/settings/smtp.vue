      ...
      <div class="block box" v-for="(item, n) in form.smtp" :key="n">
        <div class="columns">
          ...
          <div class="column" :class="{ disabled: !item.enabled }">
            ...
            <div class="columns">
              <div class="column is-8">
                <b-field :label="$t('settings.smtp.defaultEmail')" label-position="on-border">
                  <b-input
                    v-model="item.from"
                    name="from"
                    placeholder="Name <noreply@pankaj.yoursite.com>"
                    :maxlength="300"
                  />
                </b-field>
              </div>
            ...
            <div class="columns">
              ...
              <div class="column">
                <b-field grouped>
                  ...
                  <b-field
                    :label="$t('settings.mailserver.skipTLS')"
                    expanded
              ...
              <div v-if="errMsg && smtpTestItem === n">
                <b-field class="mt-4" type="is-danger">
                  <b-input
                    v-model="errMsg"
                    type="textarea"
                    custom-class="has-text-danger is-size-6"
                    readonly
                  />
                </b-field>
              </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    doSMTPTest(item, n) {
      ...
      this.errMsg = '';
      this.$api
        .testSMTP({ ...item, email: this.testEmail })
        .then(() => {
